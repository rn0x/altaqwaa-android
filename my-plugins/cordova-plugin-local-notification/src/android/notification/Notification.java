        ...
        for (Pair<Date, Intent> pair : intents) {
            ...
            try {
                ...
                if (currentApiVersion >= android.os.Build.VERSION_CODES.N) {
                    // استخدام setInexactRepeating() على أنظمة Android 14 وأحدث
                    mgr.setInexactRepeating(AlarmManager.RTC_WAKEUP, time, AlarmManager.INTERVAL_DAY, pi);
                } else {
                    // استخدام setExact() على أنظمة Android الأقدم من 14
